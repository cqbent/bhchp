...
function bhchp_preprocess_maintenance_page(&$variables, $hook) {
  // When a variable is manipulated or added in preprocess_html or
  // preprocess_page, that same work is probably needed for the maintenance page
  // as well, so we can just re-use those functions to do that work here.
  bhchp_preprocess_html($variables, $hook);
  bhchp_preprocess_page($variables, $hook);
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function bhchp_preprocess_html(&$variables, $hook) {
...
function bhchp_preprocess_node(&$variables, $hook) {
  ...
  // bhchp_preprocess_node_page() or bhchp_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function bhchp_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function bhchp_preprocess_region(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function bhchp_preprocess_block(&$variables, $hook) {
